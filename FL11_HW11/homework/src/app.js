  ...
  function createlist() {
    ...
    if (textValue !== "") {
      ...
      for (let i=n; i<j; i++) {
        ...
        /*listConatiner.ondragstart = function (){event.dataTransfer.setData('text/plain',null)};*/
        ...
        let chengeP;
        let chengePchenged;
        document.getElementById(itemBottonDoneIconsId[i]).addEventListener("click", listDone);
        ...
        document.getElementById(buttonChangeId[i]).addEventListener("click", chengeP);
        ...
        chengeP = function () {
          textValueP.innerHTML = '<input id="'+inputValuePChangeId[i]+'">';
          ...
          document.getElementById(buttonChangeId[i]).addEventListener("click", chengePchenged);

          chengePchenged = function () {
        ...
        document.getElementById(buttonDeleteId[i]).addEventListener("click", deleteList);

        let deleteList = function deleteList() {
          listConatiner = document.getElementById(listConatinerId[i]);
          listConatiner.parentNode.removeChild(listConatiner);
        }

        textValue.addEventListener('input', createlist);
        textValue.addEventListener('input', chenngeP);
        textValueNew.addEventListener('input', chengePchenged);
        textValueNew.addEventListener('input', createlist);
        imputValuePChange.addEventListener('input', createlist);
        imputValuePChange.addEventListener('input', chenngeP);
